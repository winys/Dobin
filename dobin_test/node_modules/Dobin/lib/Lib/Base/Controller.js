...
module.exports = {
	...
	*/
    ...
    session: function *(name, value, options) {
		var Session = new (require($.DOBIN_PATH+"/Lib/Util/Session.js"))(options);
		yield Session.init(this.http);
		...
		if ( $.isObject(name) ){
			var er = 0;
			for ( var key in name )
				er += instance.set(key,name[key]);
			return er;
		}
		if ( value === undefined )
			return instance.get(name);
		return yield instance.set(name,value);
	},
